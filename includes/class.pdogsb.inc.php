...
class PdoGsb
{
     ...
     *                           de valeur la quantit-%é pour ce frais
     *
     * @return null
     */
     ...
     *
      ...
      public function majFraisHorsForfait($montant,$libelle,$date,$idVisiteur,$mois)
      {
         $requetePrepare = PdoGsb::$monPdo->prepare(
    ...
    public function majFraisHorsForfait($idVisiteur,$moisV,$libelle,$date,$montant) {
    ...
    //* fonction qui valide les montants de la fiche frais du visiteur, et les ajoute à la base de données.
    
    public function validerMontant($montant,$idVisiteur,$mois) {
        $requetePrepare = PdoGSB::$monPdo->prepare(
                'UPDATE fichefrais '
    ...
    public function getVisiteurSelectionner($idVisiteur)
    {
